<x-app-layout>
  <div class="mb-6 flex space-x-4 border-b border-gray-200">
    <a href="{{ route('salas.index') }}" class="py-2 px-4 font-medium text-gray-500 hover:text-gray-800 transition-colors">Salas</a>
    <a href="{{ route('laboratorios.index') }}" class="py-2 px-4 font-bold border-b-2 border-[#76A068] text-gray-800">Laboratórios</a>
  </div>
